...
LOGGER.info("Emilia is starting. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/Desinobita (t.me/Hentai_Lover_Boy)")
...
if ENV:
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Emilia")
