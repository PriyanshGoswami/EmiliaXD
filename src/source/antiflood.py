...
from src import TIGERS, WOLVES, dispatcher
...
from src.source.sql import antiflood_sql as sql
...
from src.source.helper_funcs.alternate import send_message
from src.source.sql.approve_sql import is_approved
...
def check_flood(update, context) -> str:
    ...
    if is_TheRiZoeL(chat, user.id) or user.id in WOLVES or user.id in TIGERS:
