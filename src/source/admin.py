...
from src import DRAGONS, dispatcher
...
from src.source.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
from src.source.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from src import SUPPORT_CHAT
    ...
    if msg.reply_to_message:
        ...
        try:
            with open("gpic.png", "rb") as chatp:
                ...
                msg.reply_text("New chatpic looks Awfull")
        except BadRequest as excp:
            msg.reply_text(f"Error! {excp.message}")
        finally:
            dlmsg.delete()
