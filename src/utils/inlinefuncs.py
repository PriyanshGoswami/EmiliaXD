...
from src import arq
from src.help1.keyboard import Ikb
from src.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
...
async def inline_help_func(saxsux):
...
async def alive_function(answers):
    ...
    msg = f"""
**[Emilia Robot ❤️](https://t.me/PokemonSupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Hentai_Lover_Boy)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
